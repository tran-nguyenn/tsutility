...
import itertools
#base_group2 = base_group.toPandas()
keys = base_group2.groupby(group_agg_base).apply(list).to_dict().keys()
keys
#for key, group in itertools.groupby(base_group, key = keys):
#  print(key)
#  print(list(group))
